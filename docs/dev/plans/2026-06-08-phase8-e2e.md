...
**Spec:** [docs/dev/specs/2026-06-08-phase8-e2e-design.md](../specs/2026-06-08-phase8-e2e-design.md)

a `phase-8-e2e` branch.
...
Use the finish-branch checklist (final review, fast-forward merge) to run the final whole-branch review and merge
